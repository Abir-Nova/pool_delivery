...
def count_occurrences(input_string):
    ...
    if count == 0:
        print("The substrings 'cat', 'garden', and 'mice' are not found in the string.")
    else:
        print(f"The total number of occurrences of the substrings 'cat', 'garden', and 'mice' in the string is: {count}")
